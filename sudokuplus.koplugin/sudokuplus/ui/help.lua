...
function help.get_text(topic_id)
    ...
    elseif topic_id == "features" then
        return table.concat({
            ...
            "",
            _("### Difficulty Tiers & Custom Practice"),
            "",
            ...
            _("- **Master:** Introduces X-Wing, Swordfish, Skyscraper, Naked Quads, and Wings (XY, XYZ, W-Wing)."),
            _("- **Expert:** Introduces X-Chain, XY-Chain, AIC, Jellyfish, and Hidden Quads."),
            _("- **Custom Mode:** Practice mode to require specific strategies in a chosen tier."),
            "",
